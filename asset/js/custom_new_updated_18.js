...
// $('#progress4').hide();
    ...
    $('#inputNext4').on('click',function(){
        ...
        $('.form_3_input4').removeClass('show');
        $('.form_3_input1').removeClass('hide');
        // $('.form_3_input1').addClass('show');
        $( "#name" ).focus();
        $( "#name" ).click();

        $('#inputNext').addClass('show');
        $('#progressBar1').animate({
            width: "75%"
        }, 300);
        // $('.nice-select').addClass('open wide');
    ...
    $('#inputNext3').on('click',function(){
        ...
        // $('.main li').click( function(){
            // $('.nice-select').addClass('nice-select open');
            // $('#dropState').removeClass('nice-select');
            // $('#dropState').addClass('nice-select open');
        //   });


        // setTimeout(
        //     $('.nice-select').addClass('open'),2000
            ...
            $.ajax({
              ...
              data: { "name": name, "email": email, "phone": phone, "do_what": do_what, "source": source, "otp_value": otp_value,"device_info":currentBrowserInfo+ "  ***  "+ navigator.userAgent  }
                ...
                if(msg['message'] == "success"){
                    window.location.replace("https://upscpathshala.com/online/no1coaching_shruti/thanks/");
                }
